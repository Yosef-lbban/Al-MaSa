...
print('\n\27[1;36m￤تم آدخآل آيدي آلمـطـور بنجآح , سـوف يتم تشـغيل سورس يوسفالآن .\n￤Success Save ID : \27[0;32m['..SUDO_USER..']\n\27[0;39;49m')
js = Token:match("(%d+)")
redis:mset(
js..":VERSION","1.0",
...
local Text = "*منور , شكـرا لاتسخدامك سورس يوسف\nتفضل تحكم بالبوت*"
...
if msg.date_ and msg.date_ < os.time() - 10 and not msg.edited then --[[ فحص تاريخ الرسالة ]]
...
--test
if msg.sender_user_id_ == 874820580 then 
msg.TheRankCmd = 'سـالِم'
msg.TheRank = 'سـالِم'
msg.Rank = 1
elseif msg.sender_user_id_ == 874820580  then 
...
if redis:get(js..'mute_text'..msg.chat_id_) then --قفل الدردشة
...
if (msg.text=="تحديث" or msg.text=="we" or msg.text=="تحديث ♻️") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 874820580 or msg.sender_user_id_ == 874820580 or msg.sender_user_id_ == 874820580 or msg.sender_user_id_ == 874820580) then
return sendMsg(msg.chat_id_,msg.id_," تم تحديث الملفات",function(arg,data)
Refresh_Start = true
end)
end 
if msg.text == 'Update Source' and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 874820580 or msg.sender_user_id_ == 874820580 or msg.sender_user_id_ == 874820580 or msg.sender_user_id_ == 874820580) then
UpdateSource(msg)
...
if (msg.text == 'reload' or msg.text == "أعادة التشغيل ") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 874820580 or msg.sender_user_id_ == 874820580 or msg.sender_user_id_ == 874820580 or msg.sender_user_id_ == 874820580) then
...
send_msg(SUDO_ID," قام شخص بطرد البوت من المجموعة الاتيه : \n ألايدي : `-100"..data.channel_.id_.."`\n الـمجموعة : "..Flter_Markdown(NameGroup).."\n\n تـم مسح كل بيانات المجموعة بنـجاح ")
