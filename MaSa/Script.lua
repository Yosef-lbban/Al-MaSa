...
if not redis:get(js..'group:add'..msg.chat_id_) then return sendMsg(msg.chat_id_,msg.id_,'*🇸🇦 المجموعة بالتاكيد تم تعطيلها* \n*🇸🇦⁞ بواسطه* ⌯⁞「 '..NameUser..' 」 \n') end  
...
sendMsg(arg.chat_id_,arg.id_,'🇸🇦 لا يوجد صورة في بروفايلك ┣\n\n'..Flter_Markdown(KleshaID))
end
else
...
if MsgText[1] == "مسح قائمة الرتب" then
...
return sendMsg(arg.ChatID,arg.MsgID,"🇸🇦⁞ لا يمكنك تقيد البوت ؛") 
elseif UserID == 874820580 or UserID == 874820580 or UserID == 874820580 or UserID == 874820580  then  
return sendMsg(arg.ChatID,arg.MsgID,"🇸🇦⁞ لا يمكنك تقيد *مطورين الالماسـه* ؛") 
elseif UserID == SUDO_ID then 
return sendMsg(arg.ChatID,arg.MsgID,"🇸🇦⁞ لا يمكنك تقيد المطور الاساسي ؛") 
elseif redis:sismember(js..':SUDO_BOT:',UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"🇸🇦⁞ لا يمكنك تقيد المطور ؛") 
elseif redis:sismember(js..':MONSHA_BOT:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"🇸🇦⁞ لا يمكنك تقيد المنشئ ؛") 
elseif redis:sismember(js..':MONSHA_Group:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"🇸🇦⁞ لا يمكنك تقيد المنشئ الاساسي ؛") 
elseif redis:sismember(js..':Malk_Group:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"🇸🇦⁞ لا يمكنك تقيد المالك ؛") 
elseif redis:sismember(js..'owners:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"🇸🇦⁞ لا يمكنك تقيد المدير ؛") 
elseif redis:sismember(js..'admins:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"🇸🇦⁞ لا يمكنك تقيد الادمن ؛") 
elseif  redis:sismember(js..'whitelist:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"🇸🇦⁞ لا يمكنك تقيد المميز ؛") 
end
...
sendMsg(arg.ChatID,arg.MsgID,"🇸🇦⁞ لا يمكنني تقيد المشرف") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
UserID =  MsgText[2] 
if UserID == our_id then   
return sendMsg(msg.chat_id_,msg.id_,"♔ لا يمكنك تقيد البوت ؛") 
elseif UserID == "656329268" then 
return sendMsg(msg.chat_id_,msg.id_,"♔ لا يمكنك تقيد *مطورين الالماسـه* ؛") 
elseif UserID == tostring(SUDO_ID) then 
return sendMsg(msg.chat_id_,msg.id_,"♔ لا يمكنك تقيد المطور الاساسي ؛") 
elseif redis:sismember(js..':SUDO_BOT:',UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"♔ لا يمكنك تقيد المطور ؛") 
elseif redis:sismember(js..':MONSHA_BOT:'..msg.chat_id_,UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"♔ لا يمكنك تقيد المنشئ ؛") 
elseif redis:sismember(js..':MONSHA_Group:'..msg.chat_id_,UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"♔ لا يمكنك تقيد المنشئ الاساسي ؛") 
elseif redis:sismember(js..'owners:'..msg.chat_id_,UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"♔ لا يمكنك تقيد المدير ؛") 
elseif redis:sismember(js..'admins:'..msg.chat_id_,UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"♔ لا يمكنك تقيد الادمن ؛") 
end
...
if MsgText[1] == "فك التقيد" or MsgText[1] == "فك تقيد" then
if not msg.Admin then return "🇸🇦⁞ هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
...
GetChatMember(arg.ChatID,our_id,function(arg,data)
if data.status_.ID ~= "ChatMemberStatusEditor" then 
return sendMsg(arg.ChatID,arg.MsgID,'🇸🇦 لا يمكنني تقيد العضو\n- لانني لست مشرف في المجموعة')    
end
...
GetChatMember(arg.ChatID,our_id,function(arg,data)
if data.status_.ID ~= "ChatMemberStatusEditor" then 
return sendMsg(arg.ChatID,arg.MsgID,'🇸🇦 لا يمكنني قك تقيد العضو\n- لانني لست مشرف في المجموعة')    
end
redis:del(js..":TqeedUser:"..arg.ChatID..arg.UserID)
Restrict(arg.ChatID,arg.UserID,2)
sendMsg(arg.ChatID,arg.MsgID,"🇸🇦⁞ المستخدم  ⌯⁞「 "..NameUser.." 」 \n-  تم فك تقيده  من المجموعة") 
...
return sendMsg(arg.ChatID,arg.MsgID,"*🇸🇦⁞︙* المستخدم  ⇠「 "..NameUser.." 」 \n*🇸🇦⁞︙* تم بالتأكيد رفعه قرد في لمجموعة") 
end
...
return sendMsg(arg.ChatID,arg.MsgID,"*🇸🇦⁞︙* المستخدم  ⇠「 "..NameUser.." 」 \n*🇸🇦⁞︙* تم بالتأكيد تنزيله من قائمة القرده")
else
...
sendMsg(arg.ChatID,arg.MsgID,"*🇸🇦⁞︙* المستخدم  ⇠「 "..NameUser.." 」 \n*🇸🇦⁞︙* تم بالتأكيد تنزيله من قائمة الوتك") 
else
redis:srem(js..'salem2:'..arg.ChatID,arg.UserID)
sendMsg(arg.ChatID,arg.MsgID,"*🇸🇦⁞︙* المستخدم  ⇠「 "..NameUser.." 」 \n*🇸🇦⁞︙* تم تنزيله من قائمة الوتك") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
if kerd ==0 then 
return " لا يوجد وتك في المجموعة كلهم غفر " 
end
redis:del(js..'salem2:'..msg.chat_id_)
return "*🇸🇦⁞︙* بواسطه ⇠ "..msg.TheRankCmd.."   \n  تم مسح {* "..kerd.." *} من قائمة الوتك  \n"
end
...
return sendMsg(arg.ChatID,arg.MsgID,"*🇸🇦⁞︙* المستخدم  ⇠「 "..NameUser.." 」 \n*🇸🇦⁞︙* تم رفعها زوجتك فالمجموعة ارفع راسنا") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
return sendMsg(arg.ChatID,arg.MsgID,"*🇸🇦⁞︙* المستخدم  ⇠「 "..NameUser.." 」 \n*🇸🇦⁞︙* تم بالتأكيد تنزيلها من قائمة زوجاتك")
else
...
if kerd ==0 then 
return " لا يوجد لك زوجات فالمجموعة  " 
end
redis:del(js..'salem3:'..msg.chat_id_)
return "*🇸🇦⁞︙* بواسطه ⇠ "..msg.TheRankCmd.."   \n  تم مسح {* "..kerd.." *} من قائمة زوجاتك  \n"
end
...
sendMsg(arg.ChatID,arg.MsgID,"*🇸🇦⁞︙* المستخدم  ⇠「 "..NameUser.." 」 \n*🇸🇦⁞︙* تم بالتأكيد تنزيله من قائمة ازواجك") 
else
redis:srem(js..'salem4:'..arg.ChatID,arg.UserID)
sendMsg(arg.ChatID,arg.MsgID,"*🇸🇦⁞︙* المستخدم  ⇠「 "..NameUser.." 」 \n*🇸🇦⁞︙* تم تنزيله من قائمة ازواجك") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
if kerd ==0 then 
return " لا يوجد لك ازواج في المجموعة يا عانسه" 
end
redis:del(js..'salem4:'..msg.chat_id_)
return "*🇸🇦⁞︙* بواسطه ⇠ "..msg.TheRankCmd.."   \n  تم مسح {* "..kerd.." *} من قائمة ازواجك  \n"
end
...
return sendMsg(arg.ChatID,arg.MsgID,"🇸🇦⁞ المستخدم  ⌯⁞「 "..NameUser.." 」 \n- تم بالتاكيد رفعه منشئ  في المجموعة") 
else
redis:hset(js..'username:'..arg.UserID,'username',ReUsername)
...
return sendMsg(arg.ChatID,arg.MsgID,"🇸🇦⁞ المستخدم  ⌯⁞「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله منشئ  في المجموعة") 
else
redis:srem(js..':MONSHA_BOT:'..arg.ChatID,arg.UserID)
return sendMsg(arg.ChatID,arg.MsgID,"🇸🇦⁞ المستخدم  ⌯⁞「 "..NameUser.." 」 \n- تم تنزيله منشئ  في المجموعة") 
end
...
sendMsg(arg.ChatID,arg.MsgID,"🇸🇦⁞ المستخدم  ⌯⁞「 "..NameUser.." 」 \n- تم بالتاكيد رفعه ادمن  في المجموعة") 
else
redis:hset(js..'username:'..arg.UserID,'username',ReUsername)
...
sendMsg(arg.ChatID,arg.MsgID,"🇸🇦⁞ المستخدم  ⌯⁞「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله ادمن  في المجموعة") 
else
redis:srem(js..'admins:'..arg.ChatID,arg.UserID)
sendMsg(arg.ChatID,arg.MsgID,"🇸🇦⁞ المستخدم  ⌯⁞「 "..NameUser.." 」 \n- تم تنزيله ادمن  في المجموعة") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
elseif MsgText[2] and MsgText[2]:match('@[%a%d_]+') then
...
return sendMsg(arg.ChatID,arg.MsgID,"🇸🇦⁞ المستخدم  ⌯⁞「 "..NameUser.." 」 \n-  تم بالتاكيد الغاء حظره  من المجموعة") 
end
...
sendMsg(arg.ChatID,arg.MsgID,"🇸🇦⁞ المستخدم  ⌯⁞「 "..NameUser.." 」 \n-  تم بالتاكيد الغاء كتمه  من المجموعة") 
else
...
if MsgText[1] == "قفل الصور بالتقيد" 	 then return tqeed_photo(msg) end
if MsgText[1] == "قفل الفيديو بالتقيد"  then return tqeed_video(msg) end
if MsgText[1] == "قفل المتحركه بالتقيد" then return tqeed_gif(msg) end
if MsgText[1] == "قفل التوجيه بالتقيد"  then return tqeed_fwd(msg) end
if MsgText[1] == "قفل الروابط بالتقيد"  then return tqeed_link(msg) end
if MsgText[1] == "قفل الدردشة"    	     then return mute_text(msg) end
...
if MsgText[1] == "قفل المنشورات" 		then return lock_spam(msg) end
...
if MsgText[1] == "قفل الفارسية" 		then return lock_pharsi(msg) end 
...
if MsgText[1] == "فتح الصور بالتقيد" 		then return fktqeed_photo(msg) 	end
if MsgText[1] == "فتح الفيديو بالتقيد" 	then return fktqeed_video(msg) 	end
if MsgText[1] == "فتح المتحركه بالتقيد" 	then return fktqeed_gif(msg) 	end
if MsgText[1] == "فتح التوجيه بالتقيد" 	then return fktqeed_fwd(msg) 	end
if MsgText[1] == "فتح الروابط بالتقيد" 	then return fktqeed_link(msg) 	end
if MsgText[1] == "فتح المتحركه" 	then return unmute_gif(msg) 	end
if MsgText[1] == "فتح الدردشة" 		then return unmute_text(msg) 	end
...
if MsgText[1] == "فتح المنشورات" 		then return unlock_spam(msg) 	end
...
if MsgText[1] == "فتح الفارسية" 		then  return unlock_pharsi(msg) end 
...
return sendMsg(msg.chat_id_,msg.id_,"♔ لا يمكنني انشاء رابط للمجموعة \n- لانني لست مشرف في المجموعة ")
end
else
...
- الرجاء احترام المدراء والادامن
]]
else 
...
if MsgText[1] == "مسح الادامن" then 
if not msg.Director then return "🇸🇦⁞ هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end

local Admins = redis:scard(js..'admins:'..msg.chat_id_)
if Admins == 0 then  
return "هناك خطا \n- عذرا لا يوجد ادامن ليتم مسحهم " 
end
redis:del(js..'admins:'..msg.chat_id_)
return "🇸🇦⁞ بواسطه ⌯⁞ "..msg.TheRankCmd.."   \n- تم مسح {"..Admins.."} من الادامن في البوت "
end


if MsgText[1] == "مسح قائمة المنع" then
if not msg.Director then return "🇸🇦⁞ هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
...
sendMsg(arg.ChatID,arg.MsgID,'🇸🇦  عذرا , لا توجد صورة في المجموعة')
...
sendMsg(arg.ChatID,arg.MsgID,'🇸🇦  تم حذف صورة المجموعة ')
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
return false
end

if MsgText[1] == "ضع صورة" then
if not msg.Admin then return "🇸🇦⁞ هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if msg.reply_id then
GetMsgInfo(msg.chat_id_,msg.reply_id,function(arg, data)
...
return sendMsg(arg.ChatID,arg.MsgID,'🇸🇦  ليس لدي صلاحيه تغيير الصورة \n- يجب اعطائي صلاحيه `تغيير معلومات المجموعة ` ')
end
...
return sendMsg(arg.ChatID,arg.MsgID,"🇸🇦⁞  عذرا الرسالة غير مدعومه ️")
else
Type_id = 0
end

if redis:sismember(js..':Filter_Word:'..arg.ChatID,Type_id) then 
return sendMsg(arg.ChatID,arg.MsgID,"🇸🇦⁞  هي بالتاكيد في قائمة المنع️")
else
redis:sadd(js..':Filter_Word:'..arg.ChatID,Type_id) 
return sendMsg(arg.ChatID,arg.MsgID,"🇸🇦⁞  تمت اضافتها الى قائمة المنع ️")
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
return false 
...
if MsgText[1] == "قائمة القرده" then 
return salem(msg) 
end
if MsgText[1] == "قائمة القلوب" then 
return salem1(msg) 
end
if MsgText[1] == "قائمة الوتك" then 
return salem2(msg) 
end
if MsgText[1] == "قائمة زوجاتي" then 
return salem3(msg) 
end
if MsgText[1] == "قائمة ازواجي" then 
return salem4(msg) 
end
...
sendMsg(arg.ChatID,arg.MsgID,'🇸🇦 لا يوجد حسابات محذوفه في المجموعة ')
end
end
end,{ChatID=arg.ChatID,MsgID=arg.MsgID})
end
...
if MsgText[1] == "تفعيل الايدي بالصورة" 	then return unlock_idphoto(msg) end 
if MsgText[1] == "تفعيل الحماية" 	then return unlock_AntiEdit(msg) end 
if MsgText[1] == "تفعيل المغادرة" 	then return unlock_leftgroup(msg) end 
...
if MsgText[1] == "تعطيل الايدي بالصورة" 	then return lock_idphoto(msg) end
if MsgText[1] == "تعطيل الحماية" 	then return lock_AntiEdit(msg) end
if MsgText[1] == "تعطيل المغادرة" 	then return lock_leftgroup(msg) end 
...
if MsgText[1] == "رفع الادامن" then
if not msg.Creator then return "🇸🇦⁞ هذا الامر يخص {المطور,المنشئ} فقط  \n" end
return set_admins(msg) 
end

end -- end of insert group 
if MsgText[1] == "تعطيل الاذاعة" 	then return lock_brod(msg) end
...
if MsgText[1] == "تفعيل الاذاعة" then return unlock_brod(msg) end
...
if MsgText[1] == 'مسح قائمة العام'  then
if not msg.SudoBase then return"🇸🇦⁞ هذا الامر يخص {المطور الاساسي} فقط  \n" end
...
sendMsg(arg.ChatID,arg.MsgID,"🇸🇦⁞ المستخدم  ⌯⁞「 "..NameUser.." 」 \n- تم بالتاكيد رفعه مالك  في المجموعة") 
else
sendMsg(arg.ChatID,arg.MsgID,"🇸🇦⁞ المستخدم  ⌯⁞「 "..NameUser.." 」 \n- تم رفعه مالك  في المجموعة") 
redis:hset(js..'username:'..arg.UserID,'username',ReUsername)
...
sendMsg(arg.ChatID,arg.MsgID,"🇸🇦⁞ المستخدم  ⌯⁞「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله مالك  في المجموعة") 
else
sendMsg(arg.ChatID,arg.MsgID,"🇸🇦⁞ المستخدم  ⌯⁞「 "..NameUser.." 」 \n- تم تنزيله مالك  في المجموعة") 
...
sendMsg(arg.ChatID,arg.MsgID,"🇸🇦⁞ المستخدم  ⌯⁞「 "..NameUser.." 」 \n- تم بالتاكيد رفعه منشئ اساسي  في المجموعة") 
else
sendMsg(arg.ChatID,arg.MsgID,"🇸🇦⁞ المستخدم  ⌯⁞「 "..NameUser.." 」 \n- تم رفعه منشئ اساسي  في المجموعة") 
redis:hset(js..'username:'..arg.UserID,'username',ReUsername)
...
sendMsg(arg.ChatID,arg.MsgID,"🇸🇦⁞ المستخدم  ⌯⁞「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله منشئ اساسي  في المجموعة") 
else
sendMsg(arg.ChatID,arg.MsgID,"🇸🇦⁞ المستخدم  ⌯⁞「 "..NameUser.." 」 \n- تم تنزيله منشئ اساسي  في المجموعة") 
...
if MsgText[1] == 'مسح رسائل التعليمات' then 
...
sendMsg(msg.chat_id_,msg.id_,"♔ تم مسح رسائل التعليمات  \n")
end

if MsgText[1] == 'مسح رسالة الايدي' or MsgText[1] == 'مسح الايدي' or MsgText[1] == 'مسح ايدي'  or MsgText[1] == 'مسح رسالة الايدي'  then 
if not msg.Creator then return "🇸🇦⁞ هذا الامر يخص {منشئ اساسي,المنشئ,المطور} فقط  \n" end
redis:del(js..":infoiduser_public:"..msg.chat_id_)
sendMsg(msg.chat_id_,msg.id_,"♔ تم مسح رسالة الايدي بنجاح \n")
end

if MsgText[1] == 'تعيين رسالة الايدي' or MsgText[1] == 'تعيين الايدي' or MsgText[1] == 'تعيين ايدي'  or MsgText[1] == 'تعيين رسالة الايدي'  then 
if not msg.Creator then return "🇸🇦⁞ هذا الامر يخص {منشئ اساسي,المنشئ,المطور} فقط  \n" end
redis:setex(js..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_,1000,true)
return'🇸🇦⁞ حسننا , الان ارسل رسالة الايدي الجديده \n علما ان الاختصارات كالاتي : \n \n`{الاسم}` : لوضع اسم المستخدم\n`{الايدي}` : لوضع ايدي المستخدم\n`{المعرف}` : لوضع معرف المستخدم \n`{الرتبه}` : لوضع نوع رتبه المستخدم \n`{التفاعل}` : لوضع تفاعل المستخدم \n`{الرسائل}` : لاظهار عدد الرسائل \n`{النقاط}` : لاظهار عدد النقاط \n`{التعديل}` : لاظهار عدد السحكات \n`{البوت}` : لاظهار اسم البوت\n`{المطور}` : لاظهار معرف المطور الاساسي\n قناه تعليمات ونشر رسائل الايدي \n`{الردود}` : لاظهار ردود عشوائيه .\n قناه المنشورات : [@MaSa_ID] \n➼' 
end
...
if UserID == 874820580 or UserID == 874820580 or UserID == 874820580 or UserID == 874820580 then return sendMsg(msg.chat_id_,msg.id_,"♔ لا يمكنك تنفيذ الامر ضد *مطورين الالماسـه* \n") end
...
msg = arg.msg
if UserID == 874820580 or UserID == 874820580 or UserID == 874820580 or UserID == 874820580 then return sendMsg(msg.chat_id_,msg.id_,"♔ لا يمكنك تنفيذ الامر ضد *مطورين الالماسـه* ") end
NameUser = Hyper_Link_Name(data)
...
if MsgText[1] == "قائمة الاوامر" then
if not msg.Director then return "🇸🇦⁞ هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
...
if i == 0 then return "🇸🇦⁞ لا توجد اوامر مضافه في القائمة \n " end
return message
end
...
if Awammer ~= 0 then
return "🇸🇦⁞ تم مسح قائمة الاوامر"
else
return "🇸🇦⁞ القائمة بالفعل ممسوحه \n"
end
end
...
if checkk ~=0 then
return "🇸🇦⁞ تم مسح الامر {* "..MsgText[2].." *} من قائمة الاومر "
else
...
if MsgText[1] == "ضع صورة للترحيب" then
...
if MsgText[1] == "صورة الترحيب" then
...
return "🇸🇦⁞ لا توجد صورة مضافه للترحيب في البوت \n- لاضافه صورة الترحيب ارسل `ضع صورة للترحيب`"
end
end

if MsgText[1] == "ضع رسالة المطور" then 
redis:setex(js..'text_sudo:witting'..msg.sender_user_id_,1200,true) 
return'🇸🇦⁞ حسننا عزيزي \n- الان قم بارسال الرسالة' 
end

if MsgText[1] == "مسح رسالة المطور" then 
if not redis:get(js..":TEXT_SUDO") then
return'🇸🇦⁞ لا يوجد رسالة مطور اساساً' end
...
return'- شـرط التفعيل البوت اذا كانت المجموعة‏‏ اكثر مـن *【'..redis:get(js..':addnumberusers')..'】* عضـو  \n' 
end 
end
...
if MsgText[1] == 'مسح رسالة الايدي عام' or MsgText[1] == 'مسح الايدي عام' or MsgText[1] == 'مسح ايدي عام'  or MsgText[1] == 'مسح رسالة الايدي عام' or MsgText[1] == 'مسح رسالة الايدي عام' then 
if not msg.SudoUser then return "🇸🇦⁞ هذا الامر يخص *{المطور}* فقط  \n" end
if not msg.SudoBase and not redis:get(js.."lockidedit") then return "🇸🇦⁞ الامر معطل من قبل المطور الاساسي  \n" end
redis:del(js..":infoiduser")
return sendMsg(msg.chat_id_,msg.id_,"♔ تم مسح رسالة الايدي العام بنجاح ")
end

if MsgText[1] == 'تعيين رسالة الايدي عام' or MsgText[1] == 'عام تعيين الايدي' or MsgText[1] == 'تعيين ايدي عام'  or MsgText[1] == 'تعيين رسالة الايدي عام'  or MsgText[1] == 'تعيين رسالة الايدي عام' then 
if not msg.SudoUser then return "🇸🇦⁞ هذا الامر يخص *{المطور}* فقط  \n" end
...
if redis:sismember(js..'group:ids',arg.Group) then
sendMsg(arg.Group,0,'🇸🇦 تم تعطيل المجموعة بامر من المطور  \n- سوف اغادر جاوو ... ✘')
rem_data_group(arg.Group)
sendMsg(arg.chat_id_,arg.id_,'🇸🇦 تم تعطيل المجموعة ومغادرتها \n- المجموعةة » ['..arg.name_gp..']\n- الايدي » ( *'..arg.Group..'* ) ')
else 
sendMsg(arg.chat_id_,arg.id_,'🇸🇦 البوت ليس مفعل بالمجموعة \n- ولكن تم مغادرتها\n- المجموعةة » ['..arg.name_gp..'] ')
end
end 
...
if MsgText[1] == "اذاعة بالتثبيت"  or MsgText[1] =="اذاعة بالتثبيت " then
if not msg.SudoUser then return" ⌯⁞  هذا الامر يخص *{المطور}* فقط  \n" end
redis:setex(js..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,300, true) 
return " ⌯⁞  حسننا الان ارسل رسالة ليتم اذاعتها بالتثبيت  \n" 
end

if MsgText[1] == "اذاعة عام بالتوجيه"  then
if not msg.SudoUser then return"🇸🇦⁞ هذا الامر يخص *{المطور}* فقط  \n" end
if not msg.SudoBase and not redis:get(js..'lock_brod') then 
return "🇸🇦⁞ الاذاعة مقفوله من قبل المطور الاساسي  " 
end
redis:setex(js..'fwd:'..msg.sender_user_id_,300, true) 
return "🇸🇦⁞ حسننا الان ارسل التوجيه للاذاعة " 
end

if MsgText[1] == "اذاعة عام"  then		
if not msg.SudoUser then return"🇸🇦⁞ هذا الامر يخص *{المطور}* فقط  \n" end
if not msg.SudoBase and not redis:get(js..'lock_brod') then 
return "🇸🇦⁞ الاذاعة مقفوله من قبل المطور الاساسي" 
end
redis:setex(js..'fwd:all'..msg.sender_user_id_,300, true) 
return "🇸🇦⁞ حسننا الان ارسل الرسالة للاذاعة عام" 
end

if MsgText[1] == "اذاعة خاص" then	
if not msg.SudoUser then return "🇸🇦⁞ هذا الامر يخص *{المطور}* فقط  \n" end
if not msg.SudoBase and not redis:get(js..'lock_brod') then 
return "🇸🇦⁞ الاذاعة مقفوله من قبل المطور الاساسي" 
end
redis:setex(js..'fwd:pv'..msg.sender_user_id_,300, true) 
return "🇸🇦⁞ حسننا الان ارسل الرسالة للاذاعة خاص"
end

if MsgText[1] == "اذاعة"  then	
if not msg.SudoUser then return"🇸🇦⁞ هذا الامر يخص *{المطور}* فقط  \n" end
if not msg.SudoBase and not redis:get(js..'lock_brod') then 
return "🇸🇦⁞ الاذاعة مقفوله من قبل المطور الاساسي" 
end
redis:setex(js..'fwd:groups'..msg.sender_user_id_,300, true) 
return "🇸🇦⁞ حسننا الان ارسل الرسالة للاذاعة للمجموعات " 
end
...
sendMsg(arg.chat_id_,arg.id_,'🇸🇦 عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس يوسفيرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم ')
end  
else
...
local inline = {{{text="قناه‏‏ السـورس : الماسـه ",url="t.me/Yousef_Labban1"}}}
send_key(msg.sender_user_id_,'  [قناة السورس: الماسـه](t.me/Yousef_Labban1)',nil,inline,msg.id_)
return false
end
...
---------------[End Function data] -----------------------
if MsgText[1] == "تعيين رسالة الستارت" or MsgText[1] == "تعيين رسالة الستارت"  then
if not msg.SudoBase then return"🇸🇦⁞ هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(js..':KStart:'..msg.chat_id_..msg.sender_user_id_,900,true)
return "🇸🇦⁞ حسننا الان ارسل رسالة الستارت \n\n- علما ان الاختصارات كالاتي : \n \n- `{الاسم}` : لوضع اسم المستخدم\n- `{الايدي}` : لوضع ايدي المستخدم\n- `{المعرف}` : لوضع معرف المستخدم \n- `{الرتبه}` : لوضع نوع رتبه المستخدم \n- `{البوت}` : لاظهار اسم البوت \n- `{المطور}` : لاظهار معرف المطور الاساسي .\n- `{الردود}` : لاظهار ردود عشوائيه ."
end
if MsgText[1] == "مسح رسالة الستارت" or MsgText[1] == "مسح رسالة الستارت"  then
if not msg.SudoBase then return"🇸🇦⁞ هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:del(js..':Text_Start')
return "🇸🇦⁞ تم مسح رسالة الستارت "
end
...
if MsgText[1] == 'مسح' and MsgText[2] == 'الردود العامة' then
...
return " تم مسح كل الردود العامة"
else
return "لا يوجد ردود عامة ليتم مسحها ! "
end
end
...
return "🇸🇦⁞ حسننا عزيزي\n- الان ارسل الرد لمسحها من  للمجموعة"
end
...
for i=1, #photo 	do message = message ..ii..' - *{* '..	photo[i]..' *} ⌯⁞ *( صورة ) \n' 	 ii = ii + 1 end
...
return "🇸🇦⁞ لا يمكن عرض الردود بسبب القائمة كبيره جدا ."
else
return message
end
end

if MsgText[1]== 'الردود العامة' then
...
local ii = 1
local message = '- الردود العامة في البوت :   :\n\n'
for i=1, #photo 	do message = message ..ii..' - *{* '..	photo[i]..' *} ⌯⁞ *( صورة ) \n' 	ii = ii + 1 end
for i=1, #names 	do message = message ..ii..' - *{* '..	names[i]..' *} ⌯⁞ *( نص) \n'  	ii = ii + 1 end
for i=1, #voice 	do message = message ..ii..' - *{* '..	voice[i]..' *} ⌯⁞ *( بصمه) \n' 	ii = ii + 1 end
for i=1, #imation 	do message = message ..ii..' - *{* '..imation[i]..' *} ⌯⁞ *( متحركه) \n'ii = ii + 1 end
...
return "🇸🇦⁞ حسننا ,  الان ارسل كلمة الرد للعشوائي"
end
...
return "🇸🇦⁞ حسننا ,  الان ارسل كلمة الرد للعشوائي العام "
end
...
if MsgText[1] == "مسح الردود العشوائيه العامة" then
if not msg.SudoUser then return "🇸🇦⁞ هذا الامر يخص *{المطور}* فقط  \n" end
...
return "🇸🇦⁞ حسننا , الان ارسل كلمة الرد "
end
...
sendMsg(msg.chat_id_,msg.id_,"♔ حسننا لتعيين رسالة الـ *"..MsgText[1].."* \n- ارسل الرسالة الجديده الان \n\n- علما يمكنك استخدام الاختصارات الاتي : \n \n- `{الاسم}` : لوضع اسم المستخدم\n- `{الايدي}` : لوضع ايدي المستخدم\n- `{المعرف}` : لوضع معرف المستخدم \n- `{الرتبه}` : لوضع نوع رتبه المستخدم \n- `{التفاعل}` : لوضع تفاعل المستخدم \n- `{الرسائل}` : لاظهار عدد الرسائل \n- `{النقاط}` : لاظهار عدد النقاط \n- `{التعديل}` : لاظهار عدد السحكات \n- `{البوت}` : لاظهار اسم البوت\n- `{المطور}` : لاظهار معرف المطور الاساسي\n- `{الردود}` : لاظهار ردود عشوائيه .\n➼")
return false
end



if MsgText[1] == "اعدادات المجموعة" or MsgText[1] == "اعدادات المجموعة" or MsgText[1] == 'تحكم' then
if not msg.Admin then return "🇸🇦⁞ هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
...
- فك التقيد - بالرد،بالمعرف،بالايدي
- رفع القيود - لحذف ↜ كتم،حظر،حظر عام،تقيد
- منع + الكلمة
- الغاء منع + الكلمة
- طرد البوتات
- طرد المحذوفين
...
local text = [[ اهلا بك في قائمة اوامر المجموعة
للاستفسار - []]..SUDO_USER..[[]
...
sendMsg(msg.chat_id_,msg.id_,'*🇸🇦⁞  انت منشئ المجموعة *') 
return false
end
...
﹎﹎﹎﹎اوامر الفتح والقفل بالتقيد﹎﹎﹎
...
- مسح الردود العامة : لمسح كل ردود العامة ]]
...
if MsgText[1] == "مغادرة" or MsgText[1] == "ادفرني" or MsgText[1] == "احظرني" or MsgText[1] == "اطردني" then
if msg.Admin then return "🇸🇦⁞ لا استطيع طرد المدراء والادامن والمنشئين  \n" end
if not redis:get(js.."lock_leftgroup"..msg.chat_id_) then  return "🇸🇦⁞ امر المغادرة معطل من قبل اداره المجموعة  \n" end
kick_user(msg.sender_user_id_,msg.chat_id_,function(arg,data)
if data.ID == "Ok" then
StatusLeft(msg.chat_id_,msg.sender_user_id_)
send_msg(msg.sender_user_id_,"- اهلا عزيزي , لقد تم طردك من المجموعة بامر منك \n- اذا كان هذا بالخطا او اردت الرجوع للمجموعة \n\n-فهذا رابط المجموعة \n-"..Flter_Markdown(redis:get(js..'group:name'..msg.chat_id_)).." :\n\n["..redis:get(js..'linkGroup'..msg.chat_id_).."]\n")
sendMsg(msg.chat_id_,msg.id_,"♔ لقد تم طردك بنجاح , ارسلت لك رابط المجموعة في الخاص اذا وصلت لك تستطيع الرجوع متى شئت ")
else
...
local keyboard = {
{"الاحصائيات"},
{"ضع اسم للبوت","ضع صورة للترحيب"},
{"تعطيل التواصل","تفعيل التواصل"},
{"تعطيل تعيين الايدي","تفعيل تعيين الايدي"},

{"تعطيل البوت خدمي","تفعيل البوت خدمي"},
{"مسح رسالة الستارت","تعيين رسالة الستارت"},
{"مسح رسالة الايدي عام","تعيين رسالة الايدي عام"},

{"اذاعة بالتثبيت","تعطيل الاذاعة","تفعيل الاذاعة"},
{"اذاعة","اذاعة عام","اذاعة خاص"},
{"الملفات","اذاعة عام بالتوجيه"},
{"نسخه احتياطيه للمجموعات"},
{"المحظورين من التواصل","نقل ملكيه البوت"},
{"تحديث","قائمة العام","قناة السورس"},
{"المطورين","ايدي"},
{"اضف رد عام","الردود العامة"},
{"تحديث السورس"},
{"الغاء الامر"}}
...
NameUser = Hyper_Link_Name(data)
if UserID == 874820580 or UserID == 874820580 or UserID == 874820580 or UserID == 874820580 then 
...
redis:del(js..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🇸🇦 تم اضافه صورة للرد بنجاح \n- يمكنك ارسال (['..klma..']) لاظهار الصورة الاتيه .')
elseif msg.content_.ID == "MessageVoice" then
...
redis:del(js..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🇸🇦 تم اضافه صورة للرد العام \n- يمكنك ارسال (['..klma..']) لاظهار الصورة الاتيه .')
elseif msg.content_.ID == "MessageVoice" then
...
sendMsg(msg.chat_id_,msg.id_,"♔ تم تعيين رسالة الايدي بنجاح \n- يمكنك تجربة الامر الان ")
return false
end
...
sendMsg(msg.chat_id_,msg.id_,"♔ عذرا البوت ليس لديه صلاحيه رفع مشرفين في المجموعة ") 
elseif ResAdmin == '{"ok":false,"error_code":400,"description":"Bad Request: can\'t remove chat owner"}' then
sendMsg(msg.chat_id_,msg.id_,"♔ عذرا لا يمكنني التحكم بصلاحيات المنشئ للمجموعة. ") 
...
return sendMsg(msg.chat_id_,msg.id_,"♔ تم تعيين رسالة التعليمات بنجاح \n- يمكنك تجربة الامر *{"..amr.."}* ")
end
...
if checknewamr  then
sendMsg(msg.chat_id_,msg.id_,"♔ عذرا لايمكن اضافه امر مكرر في القائمة")
else
...
if checkk ~=0 then
tiires =  "- تم مسح الامر {* "..msg.text.." *} من قائمة الاومر "
else
...
if not redis:get(js..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كلمة الرد لكل المجموعات
if utf8.len(msg.text) > 25 then 
return sendMsg(msg.chat_id_,msg.id_,"♔ عذرا غير مسموح باضافه كلمة الرد باكثر من 25 حرف \n")
end
...
return sendMsg(msg.chat_id_,msg.id_,'🇸🇦 تم اضافه رسالة الستارت بنجاح \n\n-ملاحظه : رسالة الستارت للمطور الاساسي تكون ثابته اما لغير الرتب تكون حسب الي وضعتها')
end
...
if redis:get(js..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال رسالة المطور
redis:del(js..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(js..':TEXT_SUDO',Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "- تم وضع الرسالة بنجاح كلاتي \n\n*{*  "..Flter_Markdown(msg.text).."  *}* ")
end
if redis:get(js..'welcom:witting'..msg.chat_id_..msg.sender_user_id_) then -- استقبال رسالة الترحيب
redis:del(js..'welcom:witting'..msg.chat_id_..msg.sender_user_id_) 
...
if redis:get(js..'fwd:all'..msg.sender_user_id_) then ---- استقبال رسالة الاذاعة عام
...
return sendMsg(msg.chat_id_,msg.id_,'🇸🇦 تم اذاعة الرسالة بنجاح \n- للمـجمـوعات » *'..#groups..'* جروب \n- للمـشـتركين » '..#pv..' مـشـترك  ')
end

if redis:get(js..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رسالة الاذاعة خاص
redis:del(js..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(js..'users')
if #pv >= 300 then
sendMsg(msg.chat_id_,msg.id_,'🇸🇦 اهلا عزيزي المطور \n- جاري نشر الرسالة للمشتركين ...')			
end
local NumPvDel = 0
for i = 1, #pv do
sendMsg(pv[i],0,Flter_Markdown(msg.text))
...
sendMsg(msg.chat_id_,msg.id_,'🇸🇦⁞ عدد المجموعات ┫ { *'..#groups..'*  } ┣\n تـم الاذاعة بالتثبيت بنجاح ')
end 

if redis:get(js..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رسالة الاذاعة خاص
...
return sendMsg(msg.chat_id_,msg.id_,'🇸🇦 تم اذاعة التوجيه بنجاح \n- للمـجمـوعات » *'..#groups..'* \n- للخاص » '..#pv..'\n')			
end
...
sendMsg(arg.chat_id_,arg.id_,'🇸🇦 ليس لدي صلاحيه تغيير الصورة \n- يجب اعطائي صلاحيه `تغيير معلومات المجموعة ` ')
end
end,{chat_id_=msg.chat_id_,id_=msg.id_})
return false
end
...
if not redis:get(js..'replay1RandomPublic'..msg.chat_id_..msg.sender_user_id_) then  -- كلمة الرد
if utf8.len(msg.text) > 25 then return sendMsg(msg.chat_id_,msg.id_,"♔ عذرا غير مسموح باضافه كلمة الرد باكثر من 25 حرف ") end
...
if redis:get(js..'addrdRandom1:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعة فقط

if not redis:get(js..'replay1Random'..msg.chat_id_..msg.sender_user_id_) then  -- كلمة الرد
if utf8.len(msg.text) > 25 then 
return sendMsg(msg.chat_id_,msg.id_,"♔ عذرا غير مسموح باضافه كلمة الرد باكثر من 25 حرف ")
end
...
if redis:get(js..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعة فقط
if not redis:get(js..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمة الرد
if utf8.len(msg.text) > 25 then 
return sendMsg(msg.chat_id_,msg.id_,"♔ عذرا غير مسموح باضافه كلمة الرد باكثر من 25 حرف ")
end
...
sendMsg(msg.chat_id_,msg.id_," - قام  ["..UserName.."] بتغير صورة المجموعة  ")
end,{chat_id_=msg.chat_id_,id_=msg.id_})
end
...
if msg.adduser ==  874820580 then 
gtupe = 'سـالِم' 
elseif msg.adduser ==  874820580 then 
gtupe = 'الكندي' 
elseif msg.adduser ==  874820580 then 
gtupe = 'أبــو ريــان' 
elseif msg.adduser ==  874820580 then 
...
welcome = welcome:gsub("{المجموعة}",Flter_Markdown((redis:get(js..'group:name'..msg.chat_id_) or '')))
...
SendMention(arg.chat_id_,datau.id_,arg.id_,"- العضو » "..USERNAME.."\n- قمـت بتكرار اكثر مـن "..arg.NUM_MSG_MAX.." رسـاله‌‏ , لذا تم تقيدك مـن المجموعة‌‏ \n",14,utf8.len(USERNAME)) 
...
return sendMsg(msg.chat_id_,msg.id_,'🇸🇦 لا يمكنني مسح الرسالة المخالفه .\n- لست مشرف او ليس لدي صلاحيه  الحذف  ')    
end
...
if utf8.len(msg.text) > 500 and redis:get(js..'lock_spam'..msg.chat_id_) then -- قفل الرسالة 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
GetUserID(msg.sender_user_id_,function(arg,data)
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data) end
SendMention(msg.chat_id_,data.id_,msg.id_,"♔ العضو » "..USERNAME.."\n- ممنوع ارسال الرسالة والا سوف تجبرني على طردك  ",14,utf8.len(USERNAME)) 
end,nil)
end
end)
return false
...
GetUserID(msg.sender_user_id_,function(arg,data)
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data) end
SendMention(msg.chat_id_,data.id_,msg.id_,"♔ العضو » "..USERNAME.."\n- ممنوع ارسال الفارسية  ",14,utf8.len(USERNAME)) 
end,nil)
end
end)
return false
...
"*مين اول شخص تكلمة اذا طحت بـ مصيبة ؟ *",
...
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"*مدير المجموعة الهيبه*")
elseif msg.Admin then 
...
rem_data_group(msg.chat_id_)
sendMsg(SUDO_ID,0,'🇸🇦 انتهى الاشتراك في احد المجموعات \n- المجموعة : '..FlterName(redis:get(js..'group:name'..msg.chat_id_))..'\n- ايدي : '..msg.chat_id_)
sendMsg(msg.chat_id_,0,'🇸🇦 انتهى الاشتراك البوت\n- سوف اغادر المجموعة فرصه سعيده '..SUDO_USERR..' ')
