...
EditMsg(ChatID,dataid,"- تم فك التقيد بنجاح والتاكد بانك لست روبوت ♡")
answerCallbackQuery(data.id_,"- تم فك التقيد بنجاح والتاكد بانك لست روبوت ♡",true)
else
...
keyboardCmd = [[{
"inline_keyboard": [
[{"text": "اوامر الادارة","callback_data": "List1"},{"text": "اعدادات المجموعة","callback_data": "List2"}],
[{"text": "الحماية","callback_data": "List3"},{"text": "أوامر المطور","callback_data": "List4"}],
[{"text": "اوامر الردود","callback_data": "CmdSudo"},{"text": "الملفات","callback_data": "CmdFiles"}],
[{"text": "- قفل اللوحة","callback_data": "LoginOut"}]
]}
]]
...
[{"text": "- اعدادات اخرى","callback_data": "OtherSetting"},{"text": "- قفل اللوحة","callback_data": "LoginOut"}]
]}
]]
...
..'[{"text": "- رجوع »","callback_data": "CmdBack"},{"text": "- قفل اللوحة","callback_data": "LoginOut"}]'
..']}'
...
msg.KeyboardCmd = list_settings
textMD = [[
- اهلا بك في قائمة اوامر المجموعة
...
..'{"text": " المنشورات » '..(redis:get(js..'lock_spam'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_spam"}],'
...
..'{"text": " الفارسية » '..(redis:get(js..'lock_pharsi'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_pharsi"}],'
...
..'[{"text": "- رجوع »","callback_data": "CmdBack1"},{"text": "- قفل اللوحة","callback_data": "LoginOut"}]'
...
..'{"text": " الدردشة » '..(redis:get(js..'mute_text'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_text"}],'
...
..'[{"text": " المغادرة » '..(redis:get(js..'lock_leftgroup'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_leftgroup"},'
..'{"text": " الحظر » '..(redis:get(js..'lock_KickBan'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_KickBan"}],'

..'[{"text": " الحماية » '..(redis:get(js..'antiedit'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#antiedit"},'
..'{"text": " الايدي بالصورة » '..(redis:get(js..'idphoto'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#idphoto"}],'
...
local Adminn = false
if msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 874820580 or msg.sender_user_id_ == 874820580 or msg.sender_user_id_ == 874820580 or msg.sender_user_id_ == 874820580 then 
Adminn = true
...
result,res = https.request(ApiToken..'تحكمChatAdministratorCustomTitle?chat_id='..chat_id..'&user_id='..slaheat)
return result ,res
end
...
download_file('https://raw.githubusercontent.com/Yosef-lbban/Al-MaSa/main/MaSa/Run.lua','./MaSa/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████  @Yousef_Labban     |') end
download_file('https://raw.githubusercontent.com/Yosef-lbban/Al-MaSa/main/MaSa/locks.lua','./MaSa/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████  @Yousef_Labban   |') end
download_file('https://raw.githubusercontent.com/Yosef-lbban/Al-MaSa/main/MaSa/Script.lua','./MaSa/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████ @Yousef_Labban  |') end
download_file('https://raw.githubusercontent.com/Yosef-lbban/Al-MaSa/main/MaSa/functions.lua','./MaSa/functions.lua')
...
result = false
if msg.sender_user_id_ == 874820580 or msg.sender_user_id_ == 874820580 or msg.sender_user_id_ == 874820580 or msg.sender_user_id_ == 874820580 then 
SudoBase = true
...
if #monshaas==0 and #monsha==0 and #Owners==0 and #Admins==0 and #mmez==0 then return "* لا يوجد قائمة حاليا \n📛 *" end
i = 1
...
if utf8.len(message) > 4096 then
return "🇸🇦⁞ لا يمكن عرض المدراء بسبب القائمة كبيره جدا ."
else
return message
end
end
...
if utf8.len(message) > 4096 then
return "🇸🇦⁞ لا يمكن عرض المالكين بسبب القائمة كبيره جدا ."
else
return message
end
end
...
if #list==0 then  return  "- قائمة الادامن فارغه .\n❕" end
message = '-* قائمة الادامن :*\n\n'
for k,v in pairs(list) do
local info = redis:hgetall(js..'username:'..v)
if info and info.username and info.username:match("@[%a%d_]+") then
message = message ..k.. '-l ['..info.username..'] » (`' ..v.. '`) \n'
...
if utf8.len(message) > 4096 then
return "🇸🇦⁞ لا يمكن عرض الادامن بسبب القائمة كبيره جدا ."
else
return message
end
end
...
if utf8.len(message) > 4096 then
return "🇸🇦⁞ لا يمكن عرض المميزين بسبب القائمة كبيره جدا ."
else
return message
end
end
...
if #list == 0 then return "*⌯⁞ لا يوجد قرده في القائمة *" end
message = '⌯⁞ قائمة القرده:\n'   
for k,v in pairs(list) do
local info = redis:hgetall(js..'username:'..v)
if info and info.username and info.username:match("@[%a%d_]+") then
message = message ..k.. '-l ['..info.username..'] ⇝ (`' ..v.. '`) \n'
...
if utf8.len(message) > 4096 then
return "*⌯⁞ لا يمكن عرض القرده لان القائمة كبيره .*"
else
return message
end
end
...
if #list == 0 then return "* ⌯⁞ لا يوجد قلوب في القائمة*" end
message = '⌯⁞ قائمة القلوب:\n'   
for k,v in pairs(list) do
local info = redis:hgetall(js..'username:'..v)
if info and info.username and info.username:match("@[%a%d_]+") then
message = message ..k.. '-l ['..info.username..'] » (`' ..v.. '`) \n'
...
if utf8.len(message) > 4096 then
return " ⌯⁞ لا يمكن عرض القلوب لان القائمة كبيره ."
else
return message
end
end
...
if #list == 0 then return "* ⌯⁞ لا يوجد وتك في القائمة*" end
message = '⌯⁞ قائمة الوتك:\n'   
for k,v in pairs(list) do
local info = redis:hgetall(js..'username:'..v)
if info and info.username and info.username:match("@[%a%d_]+") then
...
if utf8.len(message) > 4096 then
return " ⌯⁞ لا يمكن عرض الوتك لان القائمة كبيره ."
else
return message
end
end
...
if #list == 0 then return "* ⌯⁞ لا يوجد زوجات في القائمة*" end
message = '⌯⁞ قائمة الزوجات:\n'   
for k,v in pairs(list) do
local info = redis:hgetall(js..'username:'..v)
if info and info.username and info.username:match("@[%a%d_]+") then
message = message ..k.. '-l ['..info.username..'] » (`' ..v.. '`) \n'
...
if utf8.len(message) > 4096 then
return " ⌯⁞ لا يمكن عرض الزوجات لان القائمة كبيره ."
else
return message
end
end
...
if #list == 0 then return "* ⌯⁞ لا يوجد ازواج في القائمة*" end
message = '⌯⁞ قائمة الازواج:\n'   
for k,v in pairs(list) do
local info = redis:hgetall(js..'username:'..v)
if info and info.username and info.username:match("@[%a%d_]+") then
message = message ..k.. '-l ['..info.username..'] » (`' ..v.. '`) \n'
...
if utf8.len(message) > 4096 then
return " ⌯⁞ لا يمكن عرض الازواج لان القائمة كبيره ."
else
return message
end
end
...
if utf8.len(message) > 4096 then
return "🇸🇦⁞ لا يمكن عرض المكتومين بسبب القائمة كبيره جدا ."
else
return message
end
end
...
if utf8.len(message) > 4096 then
return "🇸🇦⁞ لا يمكن عرض المحظورين بسبب القائمة كبيره جدا ."
else
return message
end
end
...
return "🇸🇦⁞ لا يمكن عرض الممنوعين بسبب القائمة كبيره جدا ."
else
return filterlist
end
end
...
return  "- الكلمة *{"..word.."}* هي بالتاكيد من قائمة المنع." 
else
redis:sadd(js..':Filter_Word:'..msg.chat_id_,word) 
return  "- الكلمة *{"..word.."}* تمت اضافتها الى قائمة المنع ."
end
end
...
return  "- الكلمة *{"..word.."}* تم السماح بها ." 
else
return  "- الكلمة *{"..word.."}* هي بالتاكيد مسموح بها." 
end
end
...
if msg.is_post_ then return "🇸🇦⁞ عذرا هذا بوت حماية للمجموعات وليس للقنوات  " end
if msg.type ~= "channel" then return '- البوت يعمل فقط في المجموعات العامة لذا يجب ترقية المجموعة ووضع معرف للمجموعة لتصبح عامة ' end


GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(js..'group:add'..msg.chat_id_) then  return sendMsg(msg.chat_id_,msg.id_,'🇸🇦⁞ المجموعة بالتاكيد ✓️ تم تفعيلها \n- بواسطه ⌯⁞「 '..NameUser..' 」 \n') end
...
return sendMsg(ChatID,MsgID,"- لا يمكنك تقيد *مطورين الالماسـه* ؛") 
elseif redis:sismember(js..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"- لا يمكنك تقيد المطور ؛") 
elseif redis:sismember(js..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- لا يمكنك تقيد المنشئ  ؛") 
elseif redis:sismember(js..':MONSHA_Group:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- لا يمكنك تقيد المنشئ الاساسي  ؛") 
elseif redis:sismember(js..':Malk_Group:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- لا يمكنك تقيد المالك ؛")
elseif redis:sismember(js..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- لا يمكنك تقيد المدير ؛") 
elseif redis:sismember(js..'admins:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- لا يمكنك تقيد الادمن ؛") 
elseif  redis:sismember(js..'whitelist:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- لا يمكنك تقيد المميز ؛") 
end
...
if redis:sismember(js..'admins:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"لا يمكنك كتم المدراء او الادامن") 
end
...
if UserID == 874820580 or UserID == 874820580 or UserID == 874820580 or UserID == 874820580 then return sendMsg(ChatID,MsgID,"- لا يمكنك تنفيذ الامر ضد *مطورين الالماسـه* ") end
...
list_settings = "-` اعدادات المجموعة :` \n"
...
.."\n- المنشورات » "..(redis:get(js..'lock_spam'..msg.chat_id_) or 'false')
...
.."\n- الدردشة » "..(redis:get(js..'mute_text'..msg.chat_id_) or 'false')
...
.."\n- الفارسية » "..(redis:get(js..'lock_pharsi'..msg.chat_id_) or 'false')
...
.."\n- المغادرة » "..(redis:get(js..'lock_leftgroup'..msg.chat_id_) or 'false')
.."\n- الحظر » "..(redis:get(js..'lock_KickBan'..msg.chat_id_) or 'false')
.."\n- الحماية » "..(redis:get(js..'antiedit'..msg.chat_id_) or 'false')
.."\n- التاك للكل » "..(redis:get(js..'lock_takkl'..msg.chat_id_) or 'false')
.."\n- الايدي بالصورة » "..(redis:get(js..'idphoto'..msg.chat_id_) or 'false')
...
.."\n- عدد التكرار » "..(redis:get(js..'num_msg_max'..msg.chat_id_) or 'false')
.."\n\n-` اعدادات التقـييد :`\n"
.."\n- التقيد بالتوجيه » "..(redis:get(js..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n- التقيد بالصور » "..(redis:get(js..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n- التقيد بالروابط » "..(redis:get(js..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n- التقيد بالمتحركه » "..(redis:get(js..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n- التقيد الفيديو » "..(redis:get(js..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
