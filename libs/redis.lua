...
local Text = "🙋🏼‍♂️¦ تحذير عزيزي المطور لقد توقف البوت في السيرفر بسبب انهيار مكتبه الريدز في السيرفر بس الضغط ع موارد السيرفر يرجى اعادة تشغيله باستخدام الامر service redis start  وارسالة في الترمنال "
if SUDO_ID then
